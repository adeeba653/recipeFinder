...
const browsebyarea = document.querySelector('.browsebyarea')
...
const recipescrollcontainer = document.querySelector('.recipe-scroll-container')
...
async function getImg() {
    try {
        ...
        const img_src = meal.strMealThumb
        const div = document.createElement("DIV")
        div.classList.add('recipe-card')
        div.innerHTML = `<img src="${img_src}" alt="">${name}`
        browsebyname.append(div)
